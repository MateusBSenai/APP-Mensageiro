...
URL_BASE = "https://hyqawhzkamyoehmgtmbf.supabase.co/rest/v1/usuarios"
CHAVE_API = "sb_publishable_OmWivqIqWp8tM7GO1l8slQ_Vs28VSf5"
HEADERS = {
    "apikey": CHAVE_API,
...
def exibir_lista_frases(page: ft.Page, aluno_logado, voltar_dashboard):
    ...
    try:
        ...
        usuarios = res.json()
        usuarios_ordenados = sorted(usuarios, key=lambda x: x.get('nome', '').lower())
